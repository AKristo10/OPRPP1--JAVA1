 ...
 */
public class MMBarChartDemo extends JFrame {
     ...
     */
    public MMBarChartDemo(BarChart chart) {
    ...
    private void initGUI() {
        ...
        cp.add(new MMMBarChartComponent(chart));
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            MMBarChartDemo prozor = new MMBarChartDemo(finalChart);
