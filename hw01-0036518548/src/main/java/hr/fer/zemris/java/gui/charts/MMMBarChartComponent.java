 ...
 */
public class MMMBarChartComponent extends JComponent {
     ...
     */
    public MMMBarChartComponent(BarChart chart) {
        this.chart = chart;
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        System.out.println(yNumberLength);
        int space = 20;
        int dashLength = 6;

        // Calculate origin, and end of x axis and end of y axis
        int startX = ins.left + space + fm.getHeight() + space + yNumberLength + space / 2 ;
        int startY = dim.height - ins.bottom - space - fm.getHeight() - space - fm.getHeight() - space / 2 ;
